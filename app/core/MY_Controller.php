...
class MY_Controller extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['m']= $this->m;
        $this->data['v'] = $this->v;
        $this->tbl_cloth_types = 'cloth_types';
        $this->tbl_cloth_sub_types = 'cloth_sub_types';
        $this->tbl_cloth_patterns = 'cloth_patterns';
        $this->tbl_cloth_materials = 'cloth_materials';
        $this->tbl_cloth_colors = 'cloth_colors';
        $this->tbl_cloth_upcharges = 'cloth_upcharges';
        $this->tbl_cloth_spotlists = 'cloth_spotlists';
    }
