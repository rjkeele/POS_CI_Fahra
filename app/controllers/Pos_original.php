...
class Pos extends MY_Controller {
    ...
    public function index2($sid = null, $eid = null) {
        ...
        if ($this->form_validation->run() == true && !empty($products)) {
            ...
            //get men, woman and other drclean
            $m_dclean = array();
            ...
            $this->load->view($this->theme . 'pos/index2', $this->data, $meta);
        }
    }
    ...
    public function validate_sec_pin($secPin = null) {
        ...
        if ($this->input->get('secPin')) {
            ...
            if ($this->pos_model->getUserPin($this->session->userdata('user_id'), $secPin)) {
                echo json_encode(array('secPin' => $secPin, 'success' => true));
            } else {
