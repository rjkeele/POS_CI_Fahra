                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group hide">
                                ...
                                <div class="form-group">
                                    <?= lang('set_pc', 'set_pc'); ?>
                                    <?= form_input('set_pc', $product->set_pc, 'class="form-control tip" id="set_pc"  required="required"'); ?>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_input('press_only', $product->press_only, 'class="form-control tip" id="press_only"  required="required"'); ?>
                                </div>
