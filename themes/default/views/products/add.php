                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group hide">
                                    ...
                                    <?= form_dropdown('type', $opts, set_value('type', 'service'), 'class="form-control tip select2" id="type"  required="required" style="width:100%;"'); ?>
                                </div>
                                ...
                                <div class="form-group st">
                                    <?= lang('set_pc', 'set_pc'); ?>
                                    <?= form_input('set_pc', set_value('set_pc', 0), 'class="form-control tip" id="set_pc"  required="required"'); ?>
                                </div>

                                <div class="form-group st hide">
                                    <?= lang('cost', 'cost'); ?>
                                    <?= form_input('cost', set_value('cost', 0.00), 'class="form-control tip" id="cost"  required="required"'); ?>
                                </div>

                                <div class="form-group">
                                    <?= lang('price', 'price'); ?>
                                    <?= form_input('price', set_value('price', 0.00), 'class="form-control tip" id="price"  required="required"'); ?>
                                </div>

                                <div class="form-group st">
                                    <?= lang('press_only', 'press_only'); ?>
                                    <?= form_input('press_only', set_value('press_only'), 'class="form-control tip" id="press_only"  required="required"'); ?>
                                </div>
