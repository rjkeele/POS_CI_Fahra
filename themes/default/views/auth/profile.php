                ...
                <div class="tab-content">
                    <div id="edit_profile" class="tab-pane active">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                               Security Pin
                                <?= form_input('security_pin',  $user->security_pin, 'class="form-control tip" value="" id="security_pin" type="number" min="0000" max="9999" placeholder="Enter security pin"  required="required"'); ?>
                            </div>
