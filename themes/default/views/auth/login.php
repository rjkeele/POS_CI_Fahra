    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <div class="form-group has-feedback">
                <input type="text" name="identity" value="<?= set_value('identity', (DEMO ? 'admin@tecdiary.com' : '')); ?>" class="form-control myone-input-lg" placeholder="<?= lang('email'); ?>" />
                <span class="glyphicon glyphicon-envelope form-control-feedback myone-icon-lock"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" name="password" value="<?= DEMO ? '12345678' : ''; ?>" class="form-control myone-input-lg" placeholder="<?= lang('password'); ?>" />
                <span class="glyphicon glyphicon-lock form-control-feedback myone-icon-lock"></span>
            </div>

            <div class="checkbox pull-left hide" style="margin-top: 0;">
            ...
            <button type="submit" class="btn btn-primary btn-block btn-flat myone-btn-lg"><i class="glyphicon glyphicon-log-in"></i> &nbsp;<?= lang('sign_in'); ?></button>

            <?= form_close(); ?>

            <div class="row text-center" style="padding-top: 20px;">
                <a href="#" class="text-danger" data-toggle="modal" data-target="#myModal"><?= lang('reset password'); ?></a></p>
            </div>
