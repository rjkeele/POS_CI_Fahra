...
<div class="wrapper rtl rtl-inv">
    <input type="hidden" id="hidden_sec_pin" value="">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <?php if ($this->db->dbdriver != 'sqlite3') { ?>
                        <li class="hide"><a href="<?= site_url('pos/view_bill'); ?>" target="_blank"><i
                    ...
                    <?php if ($Admin) { ?>
                        <li class="hide"><a href="<?= site_url('pos/today_sale'); ?>"
                                            data-toggle="ajax"><?= lang('today_sale'); ?></a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($suspended_sales) { ?>
                        <li class="dropdown notifications-menu" id="suspended_sales">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="footer"><a
                                            href="<?= site_url('sales/opened'); ?>"><?= lang('view_all'); ?></a>
                                </li>
                            </ul>
                        </li>
                    <?php } ?>
                    ...
                    <li>
                        <a href="<?= site_url('logout'); ?>"
                           class="sidebar-icon <?= $this->session->userdata('register_id') ? ' sign_out' : ''; ?>"><i
                                    class="fa fa-sign-out sidebar-icon"></i></a>
                    </li>
            ...
            <ul class="sidebar-menu">
                ...
                <?php if ($Admin) { ?>
                    ...
                    <li class="treeview mm_cloths">
                        ...
                        <ul class="treeview-menu">
                            <li id="cloths_list_colors"><a href="<?= site_url('cloths/colors'); ?>"><i
                                            class="fa fa-circle-o"></i> List Colors </a></li>
                            <li id="cloths_add_color"><a href="<?= site_url('cloths/add_color'); ?>"><i
                                            class="fa fa-circle-o"></i> Add Color </a></li>
                            <li id="cloths_import_color"><a href="<?= site_url('cloths/import_color'); ?>"><i
                                            class="fa fa-circle-o"></i> Import Colors </a></li>
                            <li class="divider"></li>

                            <li id="cloths_list_upcharges"><a href="<?= site_url('cloths/upcharges'); ?>"><i
                                            class="fa fa-circle-o"></i> List Upcharges </a></li>
                            <li id="cloths_add_upcharge"><a href="<?= site_url('cloths/add_upcharge'); ?>"><i
                                            class="fa fa-circle-o"></i> Add Upcharge </a></li>
                            <li id="cloths_import_upcharge"><a href="<?= site_url('cloths/import_upcharge'); ?>"><i
                                            class="fa fa-circle-o"></i> Import Upcharges </a></li>
                            <li class="divider"></li>

                            <li id="cloths_list_spotlists"><a href="<?= site_url('cloths/spotlists'); ?>"><i
                                            class="fa fa-circle-o"></i> List Spot/Damages </a></li>
                            <li id="cloths_add_spotlist"><a href="<?= site_url('cloths/add_spotlist'); ?>"><i
                                            class="fa fa-circle-o"></i> Add Spot/Damage </a></li>
                            <li id="cloths_import_spotlist"><a href="<?= site_url('cloths/import_spotlist'); ?>"><i
                                            class="fa fa-circle-o"></i> Import Spot/Damages </a></li>
                            <li class="divider"></li>

                            <li id="cloths_list_materials"><a href="<?= site_url('cloths/materials'); ?>"><i
                                            class="fa fa-circle-o"></i> List Materials </a></li>
                            <li id="cloths_add_material"><a href="<?= site_url('cloths/add_material'); ?>"><i
                                            class="fa fa-circle-o"></i> Add Material </a></li>
                            <li id="cloths_import_material"><a href="<?= site_url('cloths/import_material'); ?>"><i
            ...
            <tr>
                        ...
                        <div class="well well-sm" id="leftdiv">
                            <div id="lefttop" style="margin-bottom:5px;">
                                <div class="form-group" style="margin-bottom:5px;">
                                    <div class="input-group customer_sel_sec">
                                        <?php
                                        ...
                                        <div class="input-group-addon no-print" style="padding: 2px 5px;">
                                                    <span class="add_customer "> <a href="#" id="add-customer"
                                                                                    class="external" data-toggle="modal"
                                                                                    data-target="#myModal"><i
                                                                    class="fa fa-2x fa-plus-circle"
                                                                    id="addIcon"></i></a></span>
                                            <span class="edit_customer  hide"><a href="#" id="edit-customer"
                                                                                 class="external" data-toggle="modal"
                                                                                 data-target="#myModal1"><i
                                                            class="fa fa-2x fa-edit"
                                                            id="addIcon1"></i></a></span>
                                        </div>
                                    </div>
                                ...
                                <?php } ?>
                                <div class="form-group" style="margin-bottom:5px;">
                                    <input type="text" name="hold_ref" value="<?= $reference_note; ?>" id="hold_ref"
                                           class="form-control kb-text" placeholder="<?= lang('reference_note') ?>"/>
                                </div>
                                <div class="form-group" style="margin-bottom:5px;">
                            ...
                            <div id="print" class="fixed-table-container">
                                <div id="list-table-div">
                                    <table id="posTable"
                                        ...
                                        <thead>
                                        <tr class="success">
                                            <th style="width: 90px;text-align:center;"><?= lang('product') ?></th>
                                            <th style="width: 64px;text-align:center;"><?= lang('price') ?></th>
                                            <th style="width: 36px;text-align:center;"><?= lang('qty') ?></th>
                                            <th style="width: 50px;text-align:center;">Color</th>
                                            <th style="width: 85px;text-align:center;">Modifier</th>
                                            <th style="width: 50px;text-align:center;">material</th>
                                            <th style="width: 85px;text-align:center;"><?= lang('subtotal') ?></th>
                                            <th style="width: auto;text-align:right;" class="satu"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4" style="padding: 0;">
                                        <button type="button" class="btn btn-success btn-block btn-flat"
                                                ...
                                                style="height:67px;"><?= $eid ? lang('submit') : lang('payment'); ?></button>
                                    </div>
                                </div>
                            ...
                            <!-- <div id="payment-con" style="position: absolute; top: 540px;" >
                                    <input type="" name="spos_note" value="" id="spos_note">
                                        <input type="" name="amount" id="amount_val"
                                               value="<?= $eid ? $sale->paid : ''; ?>" />
                                        <input type="" name="balance_amount" id="balance_val" value="" />
                                        <input type="" name="paid_by" id="paid_by_val" value="due" />
                                        <input type="" name="cc_no" id="cc_no_val" value="" />
                                        <input type="" name="paying_gift_card_no" id="paying_gift_card_no_val"
                                               value="" />
                                        <input type="" name="cc_holder" id="cc_holder_val" value="" />
                                        <input type="" name="cheque_no" id="cheque_no_val" value="" />
                                        <input type="" name="cc_month" id="cc_month_val" value="" />
                                        <input type="" name="cc_year" id="cc_year_val" value="" />
                                        <input type="" name="cc_type" id="cc_type_val" value="" />
                                        <input type="" name="cc_cvv2" id="cc_cvv2_val" value="" />
                                        <input type="" name="payment_note" id="payment_note_val" value="" />
                                    <input type="" name="customer" id="customer"
                                           value="<?= $Settings->default_customer ?>" />
                                    <input type="" name="order_tax" id="tax_val" value="" />
                                    <input type="" name="order_discount" id="discount_val" value="" />
                                    <input type="" name="count" id="total_item" value="" />
                                    <input type="" name="did" id="is_delete" value="<?= $sid; ?>" />
                                    <input type="" name="eid" id="is_edit" value="<?= $eid; ?>" />
                                    <input type="" name="total_items" id="total_items" value="0" />
                                    <input type="" name="total_quantity" id="total_quantity" value="0" />
                                    <input type="" name="items_detail" id="items_detail" value="" />
                                    <input type="" name="pickup" id="pickup" value="" />
                                    <input type="" name="created_by" id="created_by" value="" />
                ...
                <td>
                    <div class="contents" id="right-col">
                        ...
                        <aside class="control-bottombar control-bottombar-dark" id="color-list">
                            <div class="upcharge-content">
                                <?php
                                if (!empty($cloth_colors)) {
                                    foreach ($cloth_colors->result() as $record) {
                                        ?>
                                        <div class="color-items">
                                            <span style="z-index:10003; background-color:<?php echo $record->name; ?>"
                                                  class="text-center color_boxes cursor" type="button"
                                                  data-name="<?php echo $record->name; ?>"
                                                  data-price="<?php echo $record->price; ?>"
                                                  data-color_name="<?php echo $record->name; ?>"><p
                                                        style="margin-top: 6px;"><?php echo $record->name == 'Skip' ? 'Skip' : ''; ?></p></span>
                                        </div>
                                        <?php
                                    }
                                }
                        ...
                        <aside class="control-bottombar control-bottombar-dark" id="damage-list">
                            <div class="upcharge-content">
                                <?php
                                if (!empty($cloth_upcharges)) {
                                    foreach ($cloth_upcharges->result() as $record) {
                                        if ($record->name == 'Spot Damage') {
                                            ?>
                                            <div class="upcharge_boxes_div">
                                                <span class="spotlist_boxes price_upate_div cursor"
                                                      data-upcharge_name="<?php echo $record->name; ?>"
                                                      data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></span>
                                            </div>
                                            <?php
                                        } else { ?>
                                            <div class="upcharge_boxes_div">
                                                <span class="upcharge_boxes price_upate_div cursor"
                                                      data-upcharge_name="<?php echo $record->name; ?>"
                                                      data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></span>
                                            </div>
                                        <?php }
                            ...
                            <div class="spot-content">
                                <?php
                                if (!empty($spot_lists)) {
                                    foreach ($spot_lists->result() as $record) {
                                        ?>
                                        <div class="spot_boxes_div">
                                            <span class="upcharge_boxes price_upate_div cursor"
                                                  data-upcharge_name="<?php echo $record->name; ?>"
                                                  data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></span>
                                        </div>
                        ...
                        <aside class="control-bottombar control-bottombar-dark" id="metrial-list">
                            <div class="">
                                <div class="">
                                    <div class="">
                                        <?php
                                        if (!empty($cloth_materials)) {
                                            foreach ($cloth_materials->result() as $record) {
                                                ?>
                                                <div class="material_boxes_div">
                                                    <span class="material_boxes price_upate_div cursor"
                                                          data-material_name="<?php echo $record->name; ?>"
                                                          data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></span>
                                                </div>
                                                <?php
                                            }
                            ...
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                    <input type="text" name="pickup_date"
                                           class="btn bg-navy btn-block btn-flat datepicker" id="pickup_date"
                                           style="height:34px; font-size: 18px;"
                                           value="<?php echo date('l', strtotime('+1 days')) == 'Sunday' ? date('m/d/Y', strtotime('+2 days')) : date('m/d/Y', strtotime('+1 days')); ?>">
                                </div>
                                <div class="btn-group">
                                    <button style="z-index:10002;" class="btn btn-primary pos-tip btn-flat"
                                            type="button" id="metrial">Metrial Patterns
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button style="z-index:10003;" class="btn btn-success pos-tip btn-flat"
                                            type="button" id="damage">Nail Paint Damage
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button style="z-index:10004;" class="btn btn-info pos-tip btn-flat"
                                            type="button" id="color">Color Patterns
                                    </button>
                                </div>
                            </div>
                        </div>
...
<div class="modal" data-easein="flipYIn" id="dsModal" tabindex="-1" role="dialog" aria-labelledby="dsModalLabel"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type='text' class='form-control input-sm kb-pad' id='get_ds' onClick='this.select();'
                       value=''>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="updateDiscount"
                        class="btn btn-primary btn-sm"><?= lang('update') ?></button>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm kb-pad" id="nPrice"
                                   onClick="this.select();" placeholder="<?= lang('new_price') ?>">
                        </div>
                        <div class="form-group">
                            <?= lang('discount', 'nDiscount') ?>
                            <input type="text" class="form-control input-sm kb-pad" id="nDiscount"
    ...
    <div class="modal-dialog modal-success">
        <div class="modal-content">
                    ...
                    <div class="col-xs-9">
                        <div class="font16">
                            <table class="table table-bordered table-condensed" style="margin-bottom: 0;">
                                ...
                                <tr>
                                    <td style="border-right-color: #FFF !important;"><?= lang("total_paying"); ?>
                                    </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <select id="paid_by" class="form-control paid_by" style="width:100%;">
                                        <option value="due">Pay on Pickup</option>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <h4><?= lang('pickup_date', 'pickup_date'); ?> <span id="pickup_date_payment"
                                                                                         class="text-center"
                                                                                         style="margin-left: 3rem;"></span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <!--                                    --><? //= lang("credit_card_no", "credit_card_no"); ?>
                                <!--                                    <input type="text" id="credit_card_no" name="card_no"-->
                                ...
                                <div class="pcc">
                                    ...
                                    <!--                                        --><? //= lang('Card Information', 'credit'); ?>
                                    <!--                                        <input type="number" id="credit_card_no" class="form-control swipe swipe_input"-->
                                    <!--                                    placeholder="Credit Card No"/>-->
                                    <!--<!--                                               placeholder="-->
                                    <? ////= lang('focus_swipe_here') ?><!--<!--"/>-->
                                    <!--                                    </div>-->
                                    <div class="form-group">
                                        <?= lang('Card Information'); ?>
                                        <input type="number" name="card_no" id="credit_card_no" class="form-control" value="4242424242424242"
                                               placeholder="Credit Card No"/>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <input type="text" name="card_name" id="pcc_name"
                                                       class="form-control kb-pad" value="AminKanji!234"
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <input type="email" name="card_email" id="pcc_email"
                                                       class="form-control kb-text" value="sales@intprocleaners.com"
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                <input type="number" name="card_month" id="pcc_month"
                                                       class="form-control kb-pad" value="12"
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="card_year" id="pcc_year"
                                                       class="form-control kb-pad" value="2020"
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="pcc_cvv2" name="card_cvc"
                                                       class="form-control kb-pad" value="123"
                                ...
                                <div class="pcash" style="display:none;">
            ...
            <div class="modal-footer">
                ...
                <? //= $eid ? '' : 'submit-sale'; ?><!--">--><? //= lang('submit') ?><!--</button>-->
                <button class="btn btn-primary" id="payment_submit" type="button">Submit</button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <?= form_input('name', '', 'class="form-control" id="cname" required="required"'); ?>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?= form_input('phone', '', 'class="form-control" id="cphone" required="required"'); ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="control-label" for="code">
                            ...
                            <div class="form-group">
                                <div class="kind_phone" style="display: flex; justify-content: space-evenly;">
                                    <div>
                                        <label class="control-label" for="code">
                                            Cell Phone
                                        </label>
                                        <?php echo form_radio('kind_phone', 'cellphone', '', "id='cellphone'"); ?>
                                    </div>
                                    <div>
                                        <label class="control-label" for="code">
                                            Voice Phone
                                        </label>
                                        <?php echo form_radio('kind_phone', 'voicephone', '', "id='voicephone'"); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?= form_input('address', '', 'class="form-control" id="address" type="textarea"'); ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?= form_input('city', '', 'class="form-control" id="city" type="text"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group" style="display: flex; justify-content: space-evenly;">
                            ...
                            <?php echo form_radio('shirt_starch', 'None', '', "id='None'"); ?>

                            <label class="control-label" for="code">
                                Light
                            </label>
                            <?php echo form_radio('shirt_starch', 'Light', '', "id='Light'"); ?>

                            <label class="control-label" for="code">
                                Medium
                            </label>
                            <?php echo form_radio('shirt_starch', 'Medium', '', "id='Medium'"); ?>

                            <label class="control-label" for="code">
                                Heavy
                            </label>
                            <?php echo form_radio('shirt_starch', 'Heavy', '', "id='Heavy'"); ?>
                            <label class="control-label" for="code">
                                Extra
                            </label>
                            <?php echo form_radio('shirt_starch', 'Extra', '', "id='Extra'"); ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group" style="display: flex; justify-content: space-evenly;">
                            ...
                            <?php echo form_radio('packing', 'Hanger', '', "id='Hanger'"); ?>
                            <label class="control-label" for="code">
                                Fold
                            </label>
                            <?php echo form_radio('packing', 'Fold', '', "id='Box'"); ?>
                            <label class="control-label" for="code">
                                HANGLONG
                            </label>
                            <?php echo form_radio('packing', 'HangLong', '', "id='HangLong'"); ?>
                        </div>
...
<!--</div>-->
<div class="modal" data-easein="flipYIn" id="customer_edit" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open("pos/edit_customer", 'id="customer-form_1"'); ?>
            <div class="modal-body">
                <div id="e-alert" class="alert alert-danger" style="display:none;"></div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <?= form_input('name', ' ', 'class="form-control" id="ename" required="required"'); ?>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="eemail">
                                    <?= lang("email_address"); ?>
                                </label>
                                <?= form_input('email', '', 'class="form-control " id="eemail"'); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?= form_input('phone', '', 'class="form-control" id="ephone" required="required"'); ?>
                            </div>
                        </div>
                        <div class="flex col-md-6">
                            ...
                            <div class="kind_phone form-group" style="display: flex; justify-content: space-evenly;">
                                <label class="control-label" for="code">
                                    Cell Phone
                                </label>
                                <?php echo form_radio('kind_phone', 'cellphone', FALSE, "id='ecellphone'"); ?>
                                <label class="control-label" for="code">
                                    Voice Phone
                                </label>
                                <?php echo form_radio('kind_phone', 'voicephone', FALSE, "id='evoicephone'"); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?= form_input('address', '', 'class="form-control" id="eaddress" type="textarea"'); ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?= form_input('city', '', 'class="form-control" id="ecity" type="text"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h4>Starch</h4>
                        <div class="form-group" style="display: flex; justify-content: space-evenly;">
                            <label class="control-label" for="eNone">
                                None
                            </label>
                            <?php echo form_radio('shirt_starch', 'None', FALSE, "id='eNone'"); ?>

                            <label class="control-label" for="eLight">
                                Light
                            </label>
                            <?php echo form_radio('shirt_starch', 'Light', FALSE, "id='eLight'"); ?>

                            <label class="control-label" for="eMedium">
                                Medium
                            </label>
                            <?php echo form_radio('shirt_starch', 'Medium', FALSE, "id='eMedium'"); ?>

                            <label class="control-label" for="eHeavy">
                                Heavy
                            </label>
                            <?php echo form_radio('shirt_starch', 'Heavy', FALSE, "id='eHeavy'"); ?>
                            <label class="control-label" for="eExtra">
                                Extra
                            </label>
                            <?php echo form_radio('shirt_starch', 'Extra', FALSE, "id='eExtra'"); ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group" style="display: flex; justify-content: space-evenly;">
                            ...
                            <?php echo form_radio('packing', 'Hanger', FALSE, "id='eHanger'"); ?>
                            <label class="control-label" for="code">
                                Fold
                            </label>
                            <?php echo form_radio('packing', 'Box', FALSE, "id='eBox'"); ?>

                            <label class="control-label" for="code">
                                HANGLONG
                            </label>
                            <?php echo form_radio('packing', 'HANGLONG', FALSE, "id='eHangLong'"); ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('ecf1', '', 'class="form-control input-sm kb-text" id="ecf1"'); ?>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('ecf2', '', 'class="form-control input-sm kb-text" id="ecf2"'); ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer" style="margin-top:0;">
                ...
                <button type="button" class="btn btn-primary"
                        id="update_customer"> <?= lang('edit_customer') ?> </button><!--submit-->
                <?= form_close(); ?>
            </div>
        </div>
    </div>
...
<div class="modal" data-easein="flipYIn" id="pos_modal" tabindex="-1" role="dialog"
     aria-labelledby="eModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header modal-primary">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                            class="fa fa-times"></i></button>
                <h4 class="modal-title" id="eModalLabel" style="margin-left:10px">
                    <?= lang('Customer Warning') ?>
                </h4>
            </div>
            <b>
                <div style="margin-left:30px; font-type: bold; " id="note_cf1"></div>
                <b>
                    <div style="margin-left:30px" id="note_cf2"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        store('spositems', JSON.stringify(<?= $items; ?>));
        $('#spos_customer').attr('value', '<?= $sale->customer_id; ?>')
            .text('<?= $sale->customer_name; ?>');
        $('#spos_customer').append(
            $('<option></option>')
                .attr('value', '<?= $sale->customer_id; ?>')
                .text('<?= $sale->customer_name; ?>')
        );

        store('spos_customer', $(this).val());
        $('#right-col').css('opacity', 1);
        $('#botbuttons').css('opacity', 1);
        $('#printhead').css('opacity', 1);
        $('#hold_ref').css('opacity', 1);
...
<script>
    Stripe.setPublishableKey('pk_test_51GuLeAHcIt8yxuDtOlKGwytlwinZOmVbaDddVNeRvyCt3aCGoJkv0Ksla3K6l1rSplUGri9ZzDxqjgmX1jtccVBv008LEqA7gx');
    ...
    $(document).ready(function () {
        ...
        $('#payment_submit').click(function () {
            ...
            if (amount == 0) alert('Please input Pay amount');
            else {
                $('#payment_submit').attr('disabled', 'disabled');

                // create single-user token to charge the user
                Stripe.createToken({
                    number: $('#credit_card_no').val(),
                    cvc: $('#pcc_cvv2').val(),
                    exp_month: $('#pcc_month').val(),
                    exp_year: $('#pcc_year').val()
    ...
    function stripeResponseHandler(status, response) {
        ...
        if (response.error) {
            ...
            var pos_form$ = $('#pos-sale-form');
            //get token id
            var token = response['id'];
            var card_email = $('#pcc_email').val();
            //insert the token into the form
            pos_form$.append("<input type='hidden' name='stripeToken' value='" + token + "'/>");
            // submit form to the server
            $('#cc_no_val').val($('#credit_card_no').val());
            $('#cc_month_val').val($('#pcc_month').val());
            $('#cc_year_val').val($('#pcc_year').val());
