                                    ...
                                    <div id="lefttop" style="margin-bottom:5px;">
                                        <div class="form-group" style="margin-bottom:5px;">
                                            <div class="input-group customer_sel_sec">
                                                ...
                                                <div class="input-group-addon no-print" style="padding: 2px 5px;">
                                                    <span class="add_customer "> <a href="#" id="add-customer" class="external" data-toggle="modal"
                                                            data-target="#myModal"><i class="fa fa-2x fa-plus-circle"
                                                        id="addIcon"></i></a></span>
                                                    <span class="edit_customer  hide"><a href="#" id="edit-customer" class="external" data-toggle="modal"
                                                            data-target="#myModal1"><i class="fa fa-2x fa-edit"
                                                   ...
                                                   style="margin:0px;" data-height="100">
                                                    <thead>
                                                        <tr class="success">
                                                            ...
                                                            <th style="width: auto;text-align:right;" class="satu"><i class="fa fa-trash-o"></i></th>
                                                        </tr>
                                                    </thead>
                                                <tbody></tbody>
                                            </table>
                            ...
                            <div class="contents" id="right-col">
                                    ...
                                    <div class="upcharge-content">
                                        ...
                                        if (!empty($cloth_colors)) {
                                            ...
                                            <div class="color-items">
                                                    <span style="z-index:10003; background-color:<?php echo $record->name; ?>" class="text-center color_boxes cursor" type="button" data-name="<?php echo $record->name; ?>"  data-price="<?php echo $record->price; ?>"  data-color_name="<?php echo $record->name; ?>"  ><p style="margin-top: 6px;"><?php echo $record->name=='Skip'?'Skip':''; ?></p></span>
                                            </div>
                                                <?php
                                            }
                                        }
                                        ...
                                        if (!empty($cloth_upcharges)) {
                                            foreach ($cloth_upcharges->result() as $record) {
                                                ...
                                                <div class="upcharge_boxes_div">
                                                    <span class="spotlist_boxes price_upate_div cursor"  data-upcharge_name="<?php echo $record->name; ?>" data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></span>
                                                </div>
                                                <?php
                                                } else {?>
                                                    <div class="upcharge_boxes_div">
                                                        <span class="upcharge_boxes price_upate_div cursor"  data-upcharge_name="<?php echo $record->name; ?>" data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></span>
                                                    </div>
                                                <?php }
                                            }
                                        }
                                            ...
                                            if (!empty($cloth_materials)) {
                                                foreach ($cloth_materials->result() as $record) {
                                                    ...
                                                    <div class="material_boxes_div">
                                                        <span class="material_boxes price_upate_div cursor"  data-material_name="<?php echo $record->name; ?>" data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></span>
                                                    </div>
                                                    <?php
                                                }
                                            }
                                ...
                                <div class="product-nav">
                                    <div class="btn-group btn-group-justified">
                                        <div class="btn-group">
                                            <input type="text" name="pickup_date" class="btn bg-navy btn-block btn-flat datepicker" id="pickup_date" style="height:34px; font-size: 18px;" value="<?php echo date('l', strtotime('+1 days'))=='Sunday'?date('m/d/Y', strtotime('+2 days')):date('m/d/Y', strtotime('+1 days')); ?>">
                                        </div>
                                        <div class="btn-group">
                                            <button style="z-index:10002;" class="btn btn-primary pos-tip btn-flat"
                                                    type="button" id="metrial">Metrial Patterns</button>
                                        </div>
                                        <div class="btn-group">
                                            <button style="z-index:10003;" class="btn btn-success pos-tip btn-flat"
                                                    type="button" id="damage">Nail Paint Damage</button>
                                        </div>
                                        <div class="btn-group">
                                            <button style="z-index:10004;" class="btn btn-info pos-tip btn-flat"
                                                    type="button" id="color">Color Patterns</button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-9">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <h4><?= lang('pickup_date', 'pickup_date'); ?> <span id="pickup_date_payment" class="text-center" style="margin-left: 3rem;"></span></h4>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="margin-top:0;">
                ...
                <button type="button" class="btn btn-primary" id="update_customer"> <?= lang('edit_customer') ?> </button><!--submit-->
                <?= form_close(); ?>
            </div>
        </div>
    </div>
...
<div class="modal" data-easein="flipYIn" id="pos_modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <b><div style="margin-left:30px; font-type: bold; " id = "note_cf1"></div><b><div style="margin-left:30px" id = "note_cf2"></div>
