...
<div class="modal-dialog" role="document"<?= $Settings->rtl ? ' dir="rtl"' : ''; ?>>
    <div class="modal-content">
            ...
            <div id="wrapper">
                        ...
                        <div>
                            <div style="text-align:center;">
                                ...
                                <div id="pick-up-data" class="dotted-bottom-border">
                                    ...
                                    <div class="text-sm pick-up-drop-date" style=" float:left; padding-bottom: 1em;"><b>Drop
                                            Date:</b>&nbsp;&nbsp; <?php echo $this->tec->hrld($inv->date); ?></div>
                                    <!--                  <p style="color: transparent;">...............................................</p>-->

                                    <div class="customer-name"><strong
                                                style="margin-top: 1em;"><?php echo $inv->customer_name; ?></strong>
                                    </div>
                                ...
                                <div style="position: relative;">
                                    <img src="<?php echo base_url('uploads/' . $inv->status . '.png'); ?>" alt=""
                                         style="position: absolute; top: -100px; left: 0; width: 100%; height: auto; opacity: 0.8;"/>
                                </div>
                                <div id="price-detail" class="dotted-bottom-border">
                                    <div class="price-detail-item">
                                        <p class="price-detail-item-name"><?= lang("total"); ?>:</p>
                                        <p class="text-right">
                                            $ <?= $this->tec->formatMoney($inv->total + $inv->product_tax); ?></p>
                                    </div>
                                    <?php
                                    if ($inv->order_tax != 0) {
                                    ...
                                    if ($Settings->rounding) {
                                        ...
                                        ?>
                                        <div class="price-detail-item"><p
                                                    class="price-detail-item-name"><?= lang("rounding"); ?>:</p>
                                            <p class="text-right">$ <?= $this->tec->formatMoney($rounding); ?></p>
                                        </div>
                                        <div class="price-detail-item"><p
                                                    class="price-detail-item-name"><?= lang("grand_total"); ?>:</p>
                                            <p class="text-right">
                                                $ <?= $this->tec->formatMoney($inv->grand_total + $rounding); ?></p>
                                        </div>
                                        <?php
                                    } else {
                                        ...
                                        <div class="price-detail-item"><p
                                                    class="price-detail-item-name"><?= lang("grand_total"); ?>:</p>
                                            <p class="text-right">
                                                $ <?= $this->tec->formatMoney($inv->grand_total); ?></p>
                                        </div>
                                        <?php
                                    }
                                    if ($inv->paid < $round_total) {
                                        ?>
                                        <div class="price-detail-item"><p
                                                    class="price-detail-item-name"><?= lang("paid_amount"); ?>:</p>
                                            <p class="text-right">$ <?= $this->tec->formatMoney($inv->paid); ?></p>
                                        </div>
                                        <div class="price-detail-item"><p
                                                    class="text-lg price-detail-item-name"><?= lang("due_amount"); ?>
                                                :</p>
                                            <p class="text-right text-lg">
                                                <b>$ <?= $this->tec->formatMoney($inv->grand_total - $inv->paid); ?></b>
                                            </p>
                                        </div>
                                        <?php
                                    }
                            ...
                            <p class="text-sm1"
                               style="text-align:justify; font-weight: initial; line-height: initial; font-size: 0.7em; text-transform: uppercase;"><?= $store->receipt_footer; ?></p>
                        </div>
                ...
                <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
                    ...
                    <?php } else { ?>
                        ...
                        <span class="w-100"><a class="btn btn-block btn-success" href="#"
        ...
        <div class="modal in" data-easein="flipYIn" id="payment_detail_modal" tabindex="-1" role="dialog" aria-labelledby="eModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-success" style="opacity: 1; display: block;">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                        <h4 class="modal-title" id="payModalLabel"> Payment Information </h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="font16">
                                    <table class="table table-bordered table-condensed" style="margin-bottom: 0;">
                                        <tbody>
                                        <tr>
                                            <td style="border-right-color: #FFF !important;">Customer</td>
                                            <td class="text-right"><span id="total_paying"><?= $store->email ?></span></td>
                                        </tr>
                                        <tr>
                                            <td width="25%" style="border-right-color: #FFF !important;">
                                                Card No</td>
                                            <td width="25%" class="text-right"><span id="item_count"><?= $payments[0]->cc_no ?></span></td>
                                        </tr>
                                        <tr>
                                            <td width="25%" style="border-right-color: #FFF !important;">
                                                Amount</td>
                                            <td width="25%" class="text-right"><span id="item_count">$<?= $payments[0]->amount ?></span></td>
                                        </tr>
                                        <tr>
                                            <td width="25%" style="border-right-color: #FFF !important;">
                                                Date</td>
                                            <td width="25%" class="text-right"><span id="item_count"><?= $payments[0]->date ?></span></td>
                                        </tr>
                                        <tr>
                                            <td width="25%" style="border-right-color: #FFF !important;">
                                                Reference</td>
                                            <td width="25%" class="text-right"><span id="item_count"><?= $payments[0]->stripe_ref ?></span></td>
                                        </tr>
                                        </tbody>
                                    </table>
        ...
        <div class="modal" data-easein="flipYIn" id="service_detail_modal" tabindex="-1" role="dialog" aria-labelledby="eModalLabel" aria-hidden="false">
            <div class="modal-dialog modal-success" style="opacity: 1; display: block;">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                        <h4 class="modal-title" id="payModalLabel"> Service Information </h4>
                    </div>
                    <div class="modal-body">
<!--                        <textarea id="xml_service">-->

                        <?php

                        $DataToPrint = json_decode($service['DataToPrint']);
//                        foreach ($DataToPrint['Items'] as $item) {
//                            print_r($item);
//                        }
                        $string = "";
                        $string .= "
...
<DOCUMENT>
    <BARCODE>".$DataToPrint->Barcode."</BARCODE>
    <PCSCOUNT>".$DataToPrint->PcsCount."</PCSCOUNT>
    <PICKUP>".$DataToPrint->PickUp."</PICKUP>
    <CUSTOMER>".$DataToPrint->Customer."</CUSTOMER>
    <PHONE>".$DataToPrint->Phone."</PHONE>
    <ITEMS>";
                        foreach ($DataToPrint->Items as $item) {
                        $string .= "
        <ITEM>
            ...
            <ITEMPRICE>".$item->Item_Price."$</ITEMPRICE>
                        ...
                        $string .="
    <ITEMS>
    <SUBTOTAL>".$DataToPrint->Subtotal."$</SUBTOTAL>
    <SALESTAX>".$DataToPrint->SalesTax."$</SALESTAX>
    <ECO>".$DataToPrint->Eco."$</ECO>
    <NET>".$DataToPrint->Net."$</NET>
    <PAID>".$DataToPrint->Paid."$</PAID>
    <BALANCE>".$DataToPrint->Balance."$</BALANCE>
</DOCUMENT>";
                ...
                <div class="modal-content">
                    ...
                    <b>
                        ...
                        <div class="modal-footer" style="margin-top:0;">
                            <button type="button" class="btn btn-primary" id="print_bt" style="margin-bottom: 0px">YES
                            </button>
    ...
    <script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#payment_detail_modal').modal();

                jQuery('#payment_detail_modal').on('hide.bs.modal', function(){
                    jQuery('#service_detail_modal').modal();
                });
                ...
                $('#print').click(function (e) {
                    ...
                    $('#print_bt').on('click', function () {
                        $.get(base_url + 'pos/printDate', {
                            print_date: currentDate_time,
                            print_id: receipt_id
                        }, function (e) {
                            // console.log(e);
