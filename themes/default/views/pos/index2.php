                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <?php if ($this->db->dbdriver != 'sqlite3') { ?>
                                <li><a href="<?= site_url('pos/view_bill'); ?>" target="_blank"><i class="fa fa-desktop"></i></a>
                                </li>
                            <?php } ?>
                            <li class="hidden-xs hidden-sm"><a href="<?= site_url('pos/shortcuts'); ?>" data-toggle="ajax"><i
                                        class="fa fa-key"></i></a></li>
                            <li><a href="<?= site_url('pos/register_details'); ?>"
                                   data-toggle="ajax"><?= lang('register_details'); ?></a></li>
                                <?php if ($Admin) { ?>
                                <li><a href="<?= site_url('pos/today_sale'); ?>" data-toggle="ajax"><?= lang('today_sale'); ?></a>
                                </li>
                            <?php } ?>
                            <li><a href="<?= site_url('pos/close_register'); ?>"
                        ...
                        <?php if ($Admin) { ?>
                            <li class="treeview mm_products">
                                <a href="#">
                                    ...
                                    <span>Item<?php // lang('products');          ?></span>
            ...
            <div class="content-wrapper">
                ...
                <table style="width:100%;" class="layout-table">
                    <tr>
                                        ...
                                        <div id="list-table-div">
                                            <div class="fixed-table-header">
                                                <table class="table table-striped table-condensed table-hover list-table"
                                                    ...
                                                    <thead>
                                                        <tr class="success">
                                                            <th>Item<?php // lang('product')          ?></th>
                                                            <th style="width: 15%;text-align:center;"><?= lang('price') ?>
                                                            </th>
                                                            <th style="width: 15%;text-align:center;"><?= lang('qty') ?></th>
                                                            <th style="width: 20%;text-align:center;"><?= lang('subtotal') ?>
                                                            </th>
                        ...
                        <td>
                            <div class="header_qty_section row col-md-12">
                                <?php for ($i = 1; $i < 10; $i++) { ?>
                                    <span class="item_cnt cursor" data-name="cloth_count" data-count="<?php echo $i; ?>"> <?php echo $i; ?></span>
                                <?php } ?>

                            </div>
                            <div class="contents row" id="right-col">

                                <div id="item-list 1234">
                                    <div class="items">
                                        <?php //echo $products; ?>
                                        <div class="mycutomcode">
                                            <style>
                                                .product-nav{
                                                    position: fixed;   
                                                }
                                            ...
                                            <div class="row col-md-12">
                                                <div class="col-md-2">
                                                    ...
                                                    if (!empty($cloth_types)) {
                                                        foreach ($cloth_types->result() as $record) {
                                                            if ($record->cloth_type == 'men') {
                                                                ?>
                                                                <div class="image_sec cloth_type_men" data-type="material"  data-name="<?php echo $record->name; ?>"  data-id="<?php echo $record->id; ?>" data-price="<?php echo $record->price; ?>">
                                                                    <?php $vehImg = base_url() . 'uploads/' . $record->image; ?>
                                                                    <img src="<?php echo $vehImg; ?>"
                                                                         alt="" width="100%" />
                                                                    <span class="image_title"><?php echo $record->name; ?></span>
                                                                </div>
                                                                <?php
                                                            }
                                                        }
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    if (!empty($cloth_types)) {
                                                        foreach ($cloth_types->result() as $record) {
                                                            if ($record->cloth_type == 'women') {
                                                                ?>
                                                                <div class="image_sec cloth_type_women" data-type="material"  data-name="<?php echo $record->name; ?>"  data-id="<?php echo $record->id; ?>" data-price="<?php echo $record->price; ?>">
                                                                    <?php $vehImg = base_url() . 'uploads/' . $record->image; ?>
                                                                    <img src="<?php echo $vehImg; ?>"
                                                                         width="100%" alt="" />
                                                                    <span class="image_title"><?php echo $record->name; ?></span>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    if (!empty($cloth_types)) {
                                                        foreach ($cloth_types->result() as $record) {
                                                            if ($record->cloth_type == 'other') {
                                                                ?>
                                                                <div class="image_sec cloth_type_other" data-type="material"  data-name="<?php echo $record->name; ?>"  data-id="<?php echo $record->id; ?>" data-price="<?php echo $record->price; ?>">
                                                                    <?php $vehImg = base_url() . 'uploads/' . $record->image; ?>
                                                                    <img src="<?php echo $vehImg; ?>"
                                                                         width="100%" alt="" />
                                                                    <span class="image_title"><?php echo $record->name; ?></span>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    if (!empty($cloth_patterns)) {
                                                        foreach ($cloth_patterns->result() as $record) {
                                                            ?>
                                                            <div class="image_sec cloth_type_pattern" data-type="material"  data-name="<?php echo $record->name; ?>"  data-id="<?php echo $record->id; ?>" data-price="<?php echo $record->price; ?>">
                                                                <?php $vehImg = base_url() . 'uploads/' . $record->image; ?>
                                                                <img src="<?php echo $vehImg; ?>"
                                                                     width="100%" alt="" />
                                                                <span class="image_title"><?php echo $record->name; ?></span>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    if (!empty($cloth_materials)) {
                                                        foreach ($cloth_materials->result() as $record) {
                                                            ?>
                                                            <div class="image_sec cloth_type_material" data-type="material"  data-name="<?php echo $record->name; ?>"  data-id="<?php echo $record->id; ?>" data-price="<?php echo $record->price; ?>">
                                                                <?php $vehImg = base_url() . 'uploads/' . $record->image; ?>
                                                                <img src="<?php echo $vehImg; ?>"
                                                                     width="100%" alt="" />
                                                                <span class="image_title"><?php echo $record->name; ?></span>
                                                ...
                                                <div class="col-md-2 color_area">
                                                    <b> Color</b>
                                                    <?php
                                                    if (!empty($cloth_colors)) {
                                                        foreach ($cloth_colors->result() as $record) {
                                                            ?>
                                                            <div class="color" id="color_<?php echo $record->name; ?>" data-color_name="<?php echo $record->name; ?>" style="background-color: <?php echo $record->name; ?>"></div>
                                                            <span class="color_title"><?php echo $record->name; ?></span>
                                                ...
                                                <div class="col-md-1 shades_area">
                                                    <b>Shades</b>
                                                    <?php
                                                    for ($i = 1; $i < 8; $i++) {
                                                        ?>
                                                        <div class="color_shade cursor" id="color_shade_<?php echo $i; ?>">
                                                        </div>
                                                        <?php
                                                    }
                                                    ?>
                                ...
                                <div class="product-nav">
                                    <div class="btn-group btn-group-justified">
                                        <!--                        //its for page traversing if products are more on the page, we removed products section so dont need it, instead we will add here upcharges
                                        <div class="btn-group">
                                        ...
                                        if (!empty($cloth_upcharges)) {
                                            foreach ($cloth_upcharges->result() as $record) {
                                                ?>
                                                <div class="btn-group">
                                                    <button style="z-index:10003;" class="btn cloth_upcharge cursor" type="button" data-price="<?php echo $record->price; ?>"><?php echo $record->name; ?></button>
                                                </div>
                                                <?php
                                            }
                                        }
                                        ?>
                                        <div class="btn-group">
                                            <button style="z-index:10003;" class="btn cursor"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Security pin</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_input('security_pin', $reference_note, 'class="form-control" id="security_pin_input"'); ?>
                </div>

            </div>
            <div class="modal-footer">

                <button type="button" id="security_pin_btn" onclick="checkSecPin()"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?= form_input('name', '', 'class="form-control" id="cname"'); ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?= form_input('address', '', 'class="form-control input-sm kb-text" id="address" type="textarea"'); ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_radio('packing', 'Hanger', '', "id='Hanger'"); ?>                                <label class="control-label" for="code">
                                Box
                            </label>
                            <?php echo form_radio('packing', 'Box', '', "id='Box'"); ?>
                        </div>
...
<script src="<?= $assets ?>dev/js/custom.js" type="text/javascript"></script>
...
<script>
    function askPin() {
        //  $('#askPinModal').modal('show');
    }


    function checkSecPin() {
            ...
            $.ajax({
                ...
                success: function (t) {
                    if (t.success) {
                        ...
                        alert('Pin Not matched Please try again!');
                    }
    ...
    $(document).on('keyup', '.select2-search__field', function (e) {
        var cname = $(this).val();
        cname1 = cname.trim().split(" ");
        console.log(cname1);
        if (cname1.length > 1 && cname1[1].length > 3) {
            ...
            $.ajax({
                ...
                url: base_url + "pos/checkCustomer",
                dataType: "json",
                success: function (t) {
                    if (t.success) {
                        return true;
                    } else {
                        var x = confirm('You like to add customer ' + cname + ' ?');
                        if (x) {
                            $('#customerModal input[name="name"]').val(cname);
    ...
    $('body').on('click', '.item_cnt', function () {
        $('.item_cnt').removeClass('selected')
        $(this).addClass('selected');
    });

    $(document).on('click', '.cloth_type_men', function () {
        $('.cloth_type_men').removeClass('selected');
        $(this).addClass('selected');
    });
    $(document).on('click', '.cloth_type_women', function () {
        $('.cloth_type_women').removeClass('selected');
        $(this).addClass('selected');
    });
    $(document).on('click', '.cloth_type_other', function () {
        $('.cloth_type_other').removeClass('selected');
        $(this).addClass('selected');
    });
    $(document).on('click', '.color', function () {
        ...
        for (var i = 1; i < 8; i++) {
            ...
            $('#color_shade_' + i + '').css({"background-color": color_name, "opacity": op});

        }
    });
    $(document).on('click', '.color_shade', function () {
        $('.color_shade').removeClass('selected');
        $(this).addClass('selected');
    });
    $(document).on('click', '.cloth_upcharge', function () {
        $(this).toggleClass('selected');
        //  $(this).addClass('selected');
    });
    function calculatePrice() {
        var selectedClothType = '';
        if ($('.cloth_type_women.selected').data('name') != '') {
            selectedClothType = 'women';
        }
        if ($('.cloth_type_men.selected').data('name') != '') {
            selectedClothType = 'men';
        }
        if ($('.cloth_type_women.selected').data('name') != '') {
            selectedClothType = 'women';
        }
        var clothPrice = $('.cloth_type_' + selectedClothType + '.selected').data('price');
        var clothName = $('.cloth_type_' + selectedClothType + '.selected').data('name');
        var clothId = $('.cloth_type_' + selectedClothType + '.selected').data('id');

        var patternName = $('.cloth_type_pattern.selected').data('name');
        var patternPrice = $('.cloth_type_pattern.selected').data('price');
        var patternId = $('.cloth_type_pattern.selected').data('price');

        var materialName = $('.cloth_type_material.selected').data('name');
        var materialPrice = $('.cloth_type_material.selected').data('price');
        var materialId = $('.cloth_type_material.selected').data('id');
