    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="mm_pickup"><a href="<?= site_url('pickup'); ?>"><i class="fa fa-check"></i> <span>Pick up</span></a></li>
                <li class="mm_tag"><a href="<?= site_url('tag'); ?>"><i class="fa fa-tags"></i> <span>Tagging</span></a></li>
                <li class="mm_rack"><a href="<?= site_url('rack'); ?>"><i class="fa fa-comment"></i> <span>Racking</span></a></li>
