...
$(document).ready(function(){$(function(){$("#view_selector").change(function(){$(".views").hide(),$("."+$(this).val()).css("display","block"),$("li."+$(this).val()).css("display","inline-block")})})}),$(function(){$(".target-link, .link-anchor").click(function(){$(".nav").toggleClass("nav-open"),$(".body-index").toggleClass("menu-open-body"),$(".target-link").toggleClass("navbar-on")})}),function(e){e.fn.aceResponsiveMenu=function(s){function i(){var s=e(window).innerWidth();if(s<=a)d.find("li.menu-active").removeClass("menu-active"),d.find("ul.slide").removeClass("slide").removeAttr("style"),d.addClass("collapse hide-menu"),d.attr("data-menu-style",""),e(".menu-toggle").show();else{if(d.attr("data-menu-style",r),d.removeClass("collapse hide-menu").removeAttr("style"),e(".menu-toggle").hide(),"accordion"==d.attr("data-menu-style"))return void d.addClass("collapse");d.find("li.menu-active").removeClass("menu-active"),d.find("ul.slide").removeClass("slide").removeAttr("style")}}var n={resizeWidth:"768",animationSpeed:"fast",accoridonExpAll:!1},s=e.extend(n,s),l=s,a=l.resizeWidth,t=l.animationSpeed,o=l.accoridonExpAll,d=e(this),r=e(this).attr("data-menu-style");return d.find("ul").addClass("sub-menu"),"accordion"==r&&e(this).addClass("collapse"),e(window).innerWidth()<=a&&i(),e(window).resize(function(){i()}),e("#menu-btn").click(function(){d.slideToggle().toggleClass("hide-menu")}),this.each(function(){d.on("mouseover","> li a",function(){return d.hasClass("collapse")!==!0&&(e(this).parent("li").siblings().children(".sub-menu").stop(!0,!0).slideUp(t).removeClass("slide").removeAttr("style").stop(),void e(this).parent().addClass("menu-active").children(".sub-menu").slideDown(t).addClass("slide"))}),d.on("mouseleave","li",function(){return d.hasClass("collapse")!==!0&&(e(this).off("click","> li a"),e(this).removeClass("menu-active"),void e(this).children("ul.sub-menu").stop(!0,!0).slideUp(t).removeClass("slide").removeAttr("style"))}),d.on("click","> li a",function(){if(d.hasClass("collapse")===!1,e(this).off("mouseover","> li a"),e(this).parent().hasClass("menu-active"))e(this).parent().children(".sub-menu").slideUp().removeClass("slide"),e(this).parent().removeClass("menu-active");else{if(1==o)return void e(this).parent().addClass("menu-active").children(".sub-menu").slideDown(t).addClass("slide");e(this).parent().siblings().removeClass("menu-active"),e(this).parent("li").siblings().children(".sub-menu").slideUp().removeClass("slide"),e(this).parent().addClass("menu-active").children(".sub-menu").slideDown(t).addClass("slide")}})})}}(jQuery),$(document).ready(function(){$("#respMenu").aceResponsiveMenu({resizeWidth:"768",animationSpeed:"fast",accoridonExpAll:!1})});
